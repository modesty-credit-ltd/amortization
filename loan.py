...
def main():
    ...
    parser.add_argument('-i', '--interest', default=12.1, dest='interest')
    parser.add_argument('-y', '--loan-years', default=None, dest='years')
    parser.add_argument('-m', '--loan-months', default=30, dest='months')
    parser.add_argument('-a', '--amount', default=30000, dest='amount')
